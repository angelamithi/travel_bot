    ...
    def call_required_functions(self, required_actions):
        ...
        for action in required_actions["tool_calls"]:
            ...
            if func_name == "search_flights":
                # Capture inputs from user's responses
                origin= arguments["origin"]
                destination= arguments["destination"]
                departure_date = arguments["departure_date"]
                
                # Call the get_personalised_recommedation function with captured inputs
...
# Update the main function to align with Tara's conversational flow
def main():
    st.title("Tara the Travel Mate - Your Personalized Travel Companion")
                            ...
                            "function": {
                                ...
                                "parameters": {
                                    ...
                                    "properties": {
                                        ...
                                        "return_date": {"type": "string", "description": "The user's planned return date.", "required": False},
